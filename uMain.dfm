object frmMain: TfrmMain
  ...
  object pgcMain: TPageControl
    ...
    object tbsEntrada: TTabSheet
      ...
      object chkTemRetencao: TCheckBox
        Left = 13
        Top = 11
        Width = 219
        Height = 31
        Caption = 'TEM RETEN'#199#195'O?'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -19
        Font.Name = 'MS Sans Serif'
    ...
    object tbsExecutar: TTabSheet
      ...
      object lblDataDePostagem: TLabel
        Left = 17
        Top = 83
        Width = 105
        Height = 13
      ...
      object chkDefinirDataPostagem: TCheckBox
        Left = 134
        Top = 105
        Width = 195
        Height = 17
        Caption = 'Definir data de postagem'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'MS Sans Serif'
